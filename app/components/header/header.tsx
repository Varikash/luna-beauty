  ...
  return (
    <>
      <header className="header-container">
        <div className='header-section logo-desctop'>
          {type === "homepage" ? <Logo size="large" color="black-titled" /> : <Logo size="small" color="black" />}
        </div>
        <div className='header-section logo-mobile'>
          <Logo size="medium" color="black-titled" />
        </div>
